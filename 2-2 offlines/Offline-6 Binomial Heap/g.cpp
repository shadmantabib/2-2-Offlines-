...
// Print Binomial Heap in level order
...
int main()
{
    ...
    /*  _heap = extractMin(_heap);
      ...
      // Union operation with multiple numbers
      list<Node*> _heap1;
       _heap1 = insert(_heap1, 3);
      _heap1 = insert(_heap1, 5);
      _heap1 = insert(_heap1, 7);
      _heap1 = insert(_heap1, 9);


      //Node* unionResult = unionMultipleNumbers(numbersToUnion);
      _heap = unionBionomialHeap(_heap,_heap1);
      _heap = adjust(_heap);


      cout << "Heap after Union operation:\n";
      printHeapLevelOrder(_heap);
      }*/
    return 0;
}
