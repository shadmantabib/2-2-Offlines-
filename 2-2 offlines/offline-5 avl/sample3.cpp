...
// Rest of the TreeNode and AVLTree implementations...
#include <iostream>
#include <fstream>
#include <vector>
#include <ctime>
...
int main() {
    ...
    for (const string& operation : input_operations) {
        ...
        if (op == 'I') {
            ...
            stringstream ss;
            avl_tree.print2D(avl_tree.root, 0, ss); // Print tree in nested parentheses format
            output_avl.push_back(ss.str());
        }
        else if (op == 'D') {
