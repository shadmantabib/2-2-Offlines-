...
class HashTable
{
    ...
    int collisionCounter, probeCounter, counter,probeCounter1;
    /*
    ...
    */
    ...
    void rehashdoubleHash(ul (*hashFunc)(string))
    {
       ...
       void rehashdel(ul (*hashFunc)(string))
    {
        int newSize = nextPrime( tblsz/2);
        vector<keyval> *newTable = new vector<keyval>[newSize];
        bool *newprevMarker = new bool[newSize];
...
public:
    ...
    void deleteChainHash(ul (*hashFunc)(string), string key)
    {
    ...
    int find_Double(ul (*hashFunc)(string), string key)
    {
        ...
        if(counter%100==0 && probeCounter1/100 >2){
